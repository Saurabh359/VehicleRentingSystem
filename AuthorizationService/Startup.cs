...
namespace AuthorizationService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAuthRepository<User>, UserOperations>();
            services.AddScoped<IAuthRepository<Vehicle>, VehicleOperations>();
            services.AddScoped<IAuthRepository<Cart>, CartOperations>();
